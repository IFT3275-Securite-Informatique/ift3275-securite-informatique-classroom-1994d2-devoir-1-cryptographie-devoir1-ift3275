...
from student_code import decrypt, dict_cryptogramme  # Remplacer par le nom de la fonction de déchiffrement
...
class TestDecryption(unittest.TestCase):
    ...
    def test_decryption_accuracy(self):
        ...
        #print("arpad dictionnaire", dictionnaire)
        ...
        #Pour les tests
        dictionnaire_cryptogramme = {valeur: key for key, valeur in dict_cryptogramme().items()}

        #fonction de comparaison
        caractere_trouve = []
        for key in dictionnaire:
          #  print("key: ", key)
          #  print("dictionnaire.get(key): ", dictionnaire.get(key))
          #  print("dictionnaire_cryptogramme.get(key): ", dictionnaire_cryptogramme.get(key))
            if(dictionnaire.get(key) == dictionnaire_cryptogramme.get(key)):
                caractere_trouve.append(key)
        print("liste de caracteres trouvés: ", caractere_trouve)
